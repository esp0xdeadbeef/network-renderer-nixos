#!/usr/bin/env bash
set -euo pipefail
# GAMP-ID: USR-MODEL-001-FS-001-HDS-002-SDS-001-001-SMS-001-002
# GAMP-ID: USR-MODEL-001-FS-001-HDS-002-SDS-001-001-SMS-001-003
# GAMP-ID: USR-MODEL-001-FS-001-HDS-002-SDS-001-001-SMS-001-CMC-001-002
# GAMP-ID: USR-MODEL-001-FS-001-HDS-002-SDS-001-001-SMS-001-CMC-001-003
...
example_root="${EXAMPLE_ROOT:-$(flake_input_path network-labs)/examples/s-router-overlay-dns-lane-policy}"
